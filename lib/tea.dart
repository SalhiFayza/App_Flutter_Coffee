      ...
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            Column(
              children: <Widget>[
                getFoodCard('assets/t1.jpg', 'Tea', '0.75', true),
                getFoodCard('assets/t2.jpg', 'Tea', '0.25', false),
                getFoodCard('assets/t3.jpg', 'Tea', '0.25', true),
            ...
            Column(
              children: <Widget>[
                ...
                getFoodCard('assets/t4.jpg', 'Tea', '0.25', true),
                getFoodCard('assets/t5.jpg', 'Tea', '0.25', false),
                getFoodCard('assets/t6.jpg', 'Tea', '0.25', true),
              ],
            )
          ],
        )
